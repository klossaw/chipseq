...
# chipseq pipeline 
for(i in samp){
  sh_fn <- "/cluster/home/danyang_jh/projects/urology/code/yingyufan/chipseq/05a_diff_peaks.sh"
  cmds1 <- glue("sh {sh_fn} {samp} &> {workdir}/log_files/{samp}_05_diff_peaks.log")
